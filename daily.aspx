<%@ Page Language="C#" AutoEventWireup="true" CodeFile="~/daily.aspx.cs"  Inherits="daily"  MasterPageFile="MasterPage.master"%>
...
<link rel="stylesheet" type="text/css" href="css/wysiwyg-editor.css" onload="getDailyById()" />
        <form id="addDailyForm" runat="server" method="post">
    <h2></h2>
    <div id="text" class="dailytext">
    </div>
         <div id="dateAndName" class="daily_date_name">
    </div>
        <div class="dailyBt" >
            <asp:button id="deleteDaily" CssClass="deleteBt" OnClientClick="return confirm('确定删除?')"  OnClick="deleteDaily_Click" runat="server" Text="删除"></asp:button><button id="editDaily" type="button" class="editBt" onclick="editDaily();goBottom();" runat="server">编辑</button>
        </div>
        <div id="dailyEditer" class="none">
...
<div class="dailyEditerAndTitle">
  <div style="color:#aa0000;font-weight:bold"></div>
        <div><div  class="dailyTitletop">
  <p class="recentDailytop">请输入标题:</p>
</div>
            <input id="dailyTitle" name="dailyTitle" type="text" class="addDailyTitle" onblur="cheakTitle();"/>
</div>
          <textarea id="editor1" name="editor" >
  </textarea>
       <div class="dailyEditerBottom">
            <button id="resetDailyBt" type="button" runat="server"  class="dailyEditerResetBt" onclick="clearTextarea()">重置</button>
            <asp:button id="editDailyBt" runat="server"    CssClass="dailyEditerSubmitBt" Text="提交" OnClick="editDailyBt_Click"></asp:button>
       </div>
</div>
        </div>
    </form>
