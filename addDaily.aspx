<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addDaily.aspx.cs" Inherits="addDaily" MasterPageFile="MasterPage.master" %>
...
<script type="text/javascript" src="js/loadRecentDaily.js" ></script>
<link rel="stylesheet" type="text/css" href="css/wysiwyg-editor.css" onload="load_ListofRecentDaily();" />
...
<div class="dailyEditerAndTitle_add">
  ...
  <p class="recentDailytop">请输入标题:</p>
       ...
       <div class="dailyEditerBottom">
            ...
            <button id="addDailyBt" runat="server"   onserverclick="addDailyBt_Click" class="dailyEditerSubmitBt" >提交</button>
       </div>
    </form>
</div>
<div class="recentDaily">
    <div class="recentDailytop">
    <p class="recentDailytopword">最近的日常记录</p>
        </div>
    <p id="list" class="recentDailyContent"></p>
</div>
        <script>
